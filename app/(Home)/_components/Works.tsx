    ...
    return <div className='py-20 w-full'>
        <div className="h-full z-20 py-32 w-[95%] max-w-custom_1 mx-auto items-start flex flex-col gap-20">
            ...
            <div className="w-full grid grid-cols-1 md:grid-cols-3 gap-4">
                ...
                <div ref={AddImageToRefs} data-scroll-speed={"3"} className="w-full lg:mt-24 relative h-[35rem] flex items-end">
                ...
                <div ref={AddImageToRefs} data-scroll-speed={"1.6"} className="w-full lg:mt-16 relative h-[35rem] flex items-end">
                ...
                <div ref={AddImageToRefs} data-scroll-speed={"2.6"} className="w-full lg:mt-8 relative h-[35rem] flex items-end">
